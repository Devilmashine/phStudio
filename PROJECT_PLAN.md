...
## Актуальный статус проекта (на 2025-06-04)
...
- Alembic-миграции для всех ключевых моделей (users, bookings, clients, calendar_events)
- CRUD-сервисы и API-роуты для clients, bookings, calendar_events (FastAPI, SQLAlchemy)
- Защита по ролям (admin/manager) для всех новых эндпоинтов
- Интеграция backend с frontend для тестирования
- Проектирование и реализация UI/UX личного кабинета, авторизация, дашборд, настройки, галерея

### В процессе
- Реализация CRUD для новостей (news) в личном кабинете **(требует доработки: e2e удаление/404)**
- Интеграция новых разделов кабинета с backend (расширение API при необходимости)
- Покрытие новых функций тестами (unit + e2e)
- Финальный UI/UX-полиш и обновление инструкций
...
1. Завершить CRUD для новостей (news) на backend и frontend
2. Интегрировать новые разделы кабинета с backend (API)
3. Покрыть новые функции тестами (unit + e2e)
4. Провести финальный UI/UX-полиш
5. Обновить документацию и инструкции по деплою
