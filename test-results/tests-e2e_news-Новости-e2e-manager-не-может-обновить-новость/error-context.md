...
- Name: Новости (e2e) >> manager не может обновить новость
- Location: /workspaces/phStudio/tests/e2e_news.spec.ts:49:3
...
Received array: [403, 404]
    at /workspaces/phStudio/tests/e2e_news.spec.ts:54:24
```
